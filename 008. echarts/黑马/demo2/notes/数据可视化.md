...
- 在 pink 老师提供的笔记的基础上，添加一些自己在学习过程中的注解说明。

**使用 vue 来实现**

pink 老师在讲解该课程时，使用的是传统方式来实现的，但是实际开发中，应该是基于 xxx 框架的基础上来实现，所以在学习过程中，就使用构建工具 vite 搭建了一个空的 vue3 工程，跟着老师的教程实现了一个同样功能的小 demo，目前已推送到 gitee 上。

### 参考资料

- [B站 ECharts数据可视化项目-大屏数据可视化展示-echarts 图表制作-pink老师直播课更新完毕）](https://www.bilibili.com/video/BV1v7411R7mp?p=5&spm_id_from=pageDriver)
  - [相关资料](https://gitee.com/xiaoqiang001/eckarts_open_class.git)
- [sf flexible.js的使用说明](https://segmentfault.com/a/1190000037430973)
...
> 7. 删除不必要的文件
>
> 使用 vite 搭建的 vue 工程中引入 less-loader 的步骤：
>
...
> 在 vue 中引入 flexible.js 的步骤：
>
> 1. `npm i lib-flexible --save`
>
> 2. 在 main.js 中，添加语句 `import "lib-flexible"` 来导入 flexible。
>
> 3. 打开控制台查看 body 元素，若如下图所示，看到一个 font-size，表示已添加成功。
>
>    <img src="https://gitee.com/dahuyou_top/pic-bed/raw/master/uPic/image-20211219194845729.png" alt="image-20211219194845729" style="zoom:50%;" />
>
> 4. 添加完成后，打开 node_modules 目录，找到 `node_modules/lib-flexible/flexible.js` 文件，ctrl + f 搜索 `var rem = width / 10` 替换为 `var rem = width / 24`，将屏幕等分为 24 份。「1920 ÷ 80 = 24」
>
> 使用插件 cssrem 自动将我们写的 px 计算为 rem 的步骤：
>
> 1. 先在 vscode 中搜索 cssrem 并安装；
>
>    <img src="https://gitee.com/dahuyou_top/pic-bed/raw/master/uPic/image-20211219202645368.png" alt="image-20211219202645368" style="zoom:50%;" />
>
>    <img src="https://gitee.com/dahuyou_top/pic-bed/raw/master/uPic/image-20211219210102702.png" alt="image-20211219210102702" style="zoom:50%;" />
>
>    打开「设置」，搜索「cssrem.rootFontSize」将默认的 1rem 为 16 px，改为 1rem 为 80px。「重启 vscode 让配置生效」
>
> 2. 当我们输入完指定 ???px 后，会有自动提示，选中它，按下 tab 键即可；
>    <img src="https://gitee.com/dahuyou_top/pic-bed/raw/master/uPic/image-20211219202818410.png" alt="image-20211219202818410" style="zoom:50%;" />

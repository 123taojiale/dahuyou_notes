...
// console.log("22-08-13 => canConstruct('a', 'b') => ", canConstruct('a', 'b'))
// console.log("22-08-13 => canConstruct('aa', 'ab') => ", canConstruct('aa', 'ab'))
// console.log("22-08-13 => canConstruct('aa', 'aab') => ", canConstruct('aa', 'aab'))
// @lc code=end

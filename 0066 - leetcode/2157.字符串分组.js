/*
 * @lc app=leetcode.cn id=2157 lang=javascript
 *
 * [2157] 字符串分组
 *
 * https://leetcode.cn/problems/groups-of-strings/description/
 *
 * algorithms
 * Hard (30.36%)
 * Likes:    40
 ...
 * - words[2] 可以得到 words[0] （删去 'b'）和 words[1] （删去 'a'）。所以 words[2] 与 words[0]
 * 和 words[1] 关联。
